...
if (isset($_POST['guardar'])){
    if(strlen($_POST['clave']) >= 1  && strlen($_POST['nombre']) >= 1 && strlen($_POST['direccion']) >= 1 &&
       ...
       strlen($_POST['email']) >= 1 && strlen($_POST['rfc']) >= 1)
       {
        ...
        $registracliente = "INSERT INTO proveedores(idproveedor, nombre, apellidos, direccion, telefono, celular, email, rfc) VALUES ('$clave','$nombre','$apellidos','$direccion','$tel','$cell','$email', '$rfc')";
